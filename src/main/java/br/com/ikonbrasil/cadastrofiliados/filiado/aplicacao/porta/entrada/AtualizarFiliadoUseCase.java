...
public interface AtualizarFiliadoUseCase {

    Filiado executar(UUID id, ComandoAtualizarFiliado comando);

    record ComandoAtualizarFiliado(
            String nomeCompleto,
            String nomeSocial,
        ...
        public ComandoAtualizarFiliado(
                String nomeCompleto,
                String nomeSocial,
                LocalDate dataNascimento,
                String cpf,
